...
CLIENT = "League of Legends"  # if you want to create a ratio for the League Client use this title
GAME = "League of Legends (TM) Client"  # if you want to create a ratio for the League of Legends game window use this title


def size(window_title: str) -> tuple:
...
def print_ratios(window_title: str) -> None:
...
def check_ratio(ratio, window_title: str) -> None:
...
print_ratios(CLIENT)
# check_ratio((0.8712, 0.9752), CLIENT)